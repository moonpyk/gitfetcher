...
//
     ...
     * @param c
     */
    exports.addProject = function (p, c) {
    ...
    /**
     * Opens the configuration file with default editor
     * @param c
     */
    exports.editConfig = function (c) {
        ...
        if (_.isEmpty(editor)) {
            console.log("Not default text editor is defined, check your EDITOR environment variable");
            return;
        }
