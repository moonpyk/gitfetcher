...
var Configuration = module.exports = (function () {
    ...
    _.extend(Configuration, {
        ...
        defaults: {
            git_bin: '/usr/bin/git',
            print_git_out: true,
            exit_on_fail: false, // TODO : Variable used but not implemented
    ...
    _.extend(Configuration.prototype, {
        ...
        fillProjects: function () {
            ...
            _(me.content).each(function (idx, key) {
                if (key === "defaults") {
                    return;
                }
                ...
                if (_.isString(me.projects[key].path)) {
                    me.projects[key].path = u.rnExpandUser(me.projects[key].path);
                }
            });
        ...
        getDefaults: function () {
            ...
            _(Configuration.defaults).each(function (idx, key) {
