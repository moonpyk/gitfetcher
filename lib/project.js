...
var Project = (function () {
    ...
    Project.prototype._asyncCallback = function (code, fn) {
        if (_.isFunction(fn)) {
            fn(code !== 0 ? {} : null, { code: 0 });
        }
    };
    ...
    Project.prototype.fetch = function (callback) {
        ...
        var me = this, args = ['fetch'], c = me.configuration;
    ...
    Project.prototype.pull = function (callback) {
        ...
        var me = this, args = ['pull'], c = me.configuration;
    ...
    Project.prototype.force_gc = function (callback) {
        ...
        var me = this, args = ['gc'], c = me.configuration;
