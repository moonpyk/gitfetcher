...
var Project = (function () {
    ...
    Project.prototype.printName = function (cb) {
        o.info(util.format("Project '%s'...", this.key), o.indent(2));
        Project.asyncCallback(0, cb);
    };
    Project.prototype.fetch = function (cb) {
    ...
    Project.prototype.gc = function (cb) {
        ...
        this.cmd(args).on('exit', function (code) {
            if (code === 0) {
                ...
                o.error(util.format("Error during GC (%d).", code), o.indent(5));
            }
            Project.asyncCallback(code, cb);
        });
    };
    Project.prototype.force_gc = function (cb) {
