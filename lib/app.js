...
var App = (function () {
    ...
    App.prototype.main = function (argv) {
        ...
        if (program['listProjects']) {
            ...
            _(c.fillProjects()).each(function (p, key) {
        ...
        var projectsTasks = _(c.fillProjects()).map(function (conf, key) {
            return _this.handleProject(key, conf, projectMode, context, pretend);
        }).value();
    ...
    App.prototype.handleProject = function (key, conf, projectMode, context, pretend) {
