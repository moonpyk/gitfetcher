...
function replaceFileExtension(test) {
    test.equals(u.replaceFileExtension('/qsdsd/qsdsqd/filename.json', '.html'), '/qsdsd/qsdsqd/filename.html');

    test.equals(u.replaceFileExtension('/qsdsd/qsdsqd/filename.', '.json'), '/qsdsd/qsdsqd/filename.json');

    test.equals(u.replaceFileExtension('/qsdsd/qsdsqd/filename', '.json'), '/qsdsd/qsdsqd/filename.json');

    test.equal(u.replaceFileExtension('filename', '.json'), 'filename.json');

    test.equal(u.replaceFileExtension(null, '.tt'), null);
